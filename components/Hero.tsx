      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 text-center relative z-10 w-full">
        ...
        >
          ...
          >
              ...
              <motion.div
                  layout
                  className="relative group px-4 py-1.5 cursor-pointer rounded-3xl md:rounded-l-full hover:bg-white/5 dark:hover:bg-slate-100/50 transition-colors duration-300"
                  ...
                  <div className="flex flex-col items-start justify-center h-full relative">
                        ...
                        <div className="flex items-center gap-2 w-full">
                           ...
                           <input
                              ref={inputRefKeyword}
                              type="text"
                              className="w-full bg-transparent border-none p-0 text-base font-bold text-white dark:text-slate-900 placeholder:text-slate-600 dark:placeholder:text-slate-400 focus:ring-0 outline-none leading-none tracking-tight cursor-pointer"
                              ...
                              autoComplete="off"
                            />
                            <IconChevronDown className={`w-3.5 h-3.5 transition-transform duration-300 ${focusedField === 'keyword' ? 'rotate-180 text-primary-500' : 'text-slate-600 dark:text-slate-400'}`} />
                        </div>
                  </div>
                  <AnimatePresence>
                    {focusedField === 'keyword' && (
                      <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className="absolute top-[120%] left-0 w-[180%] min-w-[340px] max-h-[400px] overflow-y-auto p-3 bg-slate-900/95 dark:bg-white/95 backdrop-blur-2xl border border-slate-700 dark:border-slate-200 rounded-3xl shadow-2xl z-50"
                      >
                         <div className="px-2 py-2 text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2 sticky top-0 bg-slate-900/95 dark:bg-white/95 backdrop-blur-md z-10 mx-1">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                           {filteredCategories.map((item) => (
                            <motion.button
                              ...
                              className="w-full text-left px-3 py-2.5 text-sm font-medium text-slate-300 dark:text-slate-700 hover:bg-slate-800 dark:hover:bg-slate-100 rounded-xl transition-colors flex items-center gap-2.5 group/item border border-transparent hover:border-slate-700 dark:hover:border-slate-200"
                              whileHover={{ scale: 1.02 }}
                              whileTap={{ scale: 0.98 }}
                            >
                              <div className="w-8 h-8 rounded-lg bg-slate-800 dark:bg-slate-100 flex items-center justify-center text-slate-400 dark:text-slate-500 group-hover/item:text-primary-500 group-hover/item:bg-primary-500/10 transition-colors shrink-0">
                                 {item.icon}
                              </div>
